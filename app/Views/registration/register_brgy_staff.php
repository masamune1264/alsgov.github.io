    ...
    <body class="bg-light-danger">
        <div class="container-fluid">
            <div class="row justify-content-center mt-3">
                <div class="col-md-6">
                    <div class="card smooth-shadow-sm p-5">
                        <div id="form_message">
                            <span id="in_mess"></span>
                        </div>
                        <form action="<?=base_url('registration/brgy_staff')?>" method="post" id="create_account" enctype="multipart/form-data">
                            <!-- < ?=csrf_field();?>
                            < ?php if (isset($error)) : ?>
                            ...
                            < ?php endif; ?> -->
                            <h3 class="text-danger fw-bold">Registration</h3>
                            <span class="form-label">Register to create barangay staff account</span>
                            <br><br>
                            <div class="mb-3">
                                <div class="row gx-3">
                                    <div class="col-md-6">
                            ...
                            <div class="d-grid gap-2 mb-3">
                                <button id="submit" class="btn btn-danger py-2 fw-bold" type="submit" disabled>Register</button>
                            </div>
                            <div class="row justify-content-between">
                                <div class="col-md-6">
                                    <a href="<?=base_url('staff/login')?>" class="link-primary" >Sign In</a></small>
                                </div>
                                <div class="col-md-6 text-end">
                                    <a href="<?=base_url('staff/forgot_password')?>" class="link-primar y">Forgot Password</a>
                                </div>
                            </div>
                        </form>
                    </div>
