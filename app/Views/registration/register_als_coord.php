            ...
            <div class="row justify-content-center mt-3">
                <div class="col-md-6">
                    <div class="card p-5 rounded shadow">
                        <form id="create_account" enctype="multipart/form-data">
                            <!-- < ?=csrf_field();?>
                            < ?php if (isset($error)) : ?>
                            ...
                            <span class="form-label">Register to create ALS coordinator account</span>
                            <br><br>
                            <div class="mb-3">
                                <div class="row gx-3">
                                    <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <small for="" class="form-text">(Where you work as ALS coordinator)</small>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <br>
                                    <a href="<?=base_url('alscoordinator/login')?>" class="text-blue-3" style="text-decoration: none!important;" >Sign In</a>
                                </div>
                                <div class="col-md-6 text-end">
                                    <br>
                                    <a href="<?=base_url('alscoordinator/forgot_password')?>" class="text-dark" style="text-decoration: none!important;" >Forgot Password</a>
                                </div>
                            </div>
                        </form>
                    </div>
