...
<html lang="en">
    ...
    <body class="bg-light-primary">
            ...
            <div class="row justify-content-center mt-3">
                <div class="col-md-6">
                    <div class="card p-5 rounded shadow">
                        <form action="<?=base_url('registration/als_teacher')?>" method="post" id="create_account" enctype="multipart/form-data">
                            <!-- < ?=csrf_field();?>
                            < ?php if (isset($error)) : ?>
                            ...
                            < ?php endif; ?> -->
                            <h3 class="text-primary fw-bold">Registration</h3>
                            <label class="form-label">Register to create ALS Teacher account</label>
                            <br><br>
                            <div class="mb-3">
                                <div class="row gx-3">
                                    <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <small for="" class="form-text">(Where you work as ALS teacher)</small>
                            ...
                            <!-- <div class="mb-3">
                                ...
                                <select name="barangay" id="barangay" class="form-select py-2">
                                    ...
                                    <option value="" id="selectOption"></option>
                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <br>
                                    <small ><a href="<?=base_url('teacher/login')?>" class="text-blue-3" style="text-decoration: none!important;" >Sign In</a></small>
                                </div>
                                <div class="col-md-6 text-end">
                                    <br>
                                    <small ><a href="<?=base_url('teacher/forgot_password')?>" class="text-dark" style="text-decoration: none!important;" >Forgot Password</a></small>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script>
            ...
            //         fetch('<?=base_url('registration/als_teacher')?>', {
            //             method:'post',
            //             body:accountData
            //         })
