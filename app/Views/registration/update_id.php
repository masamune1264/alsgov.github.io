            ...
            <div class="row justify-content-center mt-3">
                <div class="col-md-6">
                    <div class="card p-5 rounded shadow">
                        <form action="<?=base_url('registration/update_id') . '/' . $staff['id']?>" method="POST" enctype="multipart/form-data">
                            <!-- < ?=csrf_field();?>
                            < ?php if (isset($error)) : ?>
                            ...
                            < ?php endif; ?> -->
                            <h3 class="text-danger fw-bold">Barangay Staff</h3>
                            ...
                            <div class="d-grid gap-2">
                                <button id="submit" class="btn btn-danger" type="submit" disabled>Update Valid ID</button>
                            </div>
                            <div class="row">
