            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-5">
                    <div class="light p-2 rounded shadow">
                        <form action="<?=base_url('alscoordinator/reset_password' .'/'.$user_id)?>" method="post">
                            <?=csrf_field();?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="new_pass" id="new_pass" class="login-input" placeholder="New Password"  value="<?=set_value('new_pass')?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="conf_pass" id="conf_pass" class="login-input" placeholder="Confirm Password"  value="<?=set_value('conf_pass')?>">
