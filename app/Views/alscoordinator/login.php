                ...
                <div class="col-12 col-md-8 col-lg-6 col-xxl-4 py-8 py-xl-0">
                    ...
                    <div class="card smooth-shadow-md">
                        ...
                        <div class="card-body p-6">
                            <form action="<?=base_url('alscoordinator/login')?>" method="post">
                                <div class="mb-4">
                                ...
                                <div>
                                    ...
                                    <!-- div class="d-md-flex justify-content-between mt-4">
                                        <div class="mb-2 mb-md-0">
                                            <a href="<?=base_url('registration/als_coordinator')?>" class="fs-5">Create An Account </a>
                                        </div>
                                    <div>
                                    <a href="<?=base_url('alscoordinator/forgot_password')?>" class="text-inherit fs-5">Forgot your password?</a>
                                </div -->
