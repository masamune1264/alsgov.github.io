                            ...
                            <table class="table text-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <?php if(!empty($register) || is_array($register)):?>
                                        <?php foreach($register as $coord): ?>
                                            <tr>
                                                <td class="align-middle">
                                                    <div class="d-flex align-items-center">
                                                        <div class="ms-3 lh-1">
                                                            <h5 class=" mb-1 fw-bold"><?=$coord['user_id']?></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle">
                                                    <span class="fw-bold text-primary"><?=$coord['username']?></span><br>
                                                    <small><?=$coord['email']?></small>
                                                </td>
                                                <td class="align-middle"><?=$coord['firstname'] . ' ' . $coord['lastname']?></td>
                                                <td class="align-middle"><?=$coord['district']?></td>
                                                ...
                                                <td class="align-middle text-dark">
                                                    ...
                                                    <div class="dropdown dropstart">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownprojectOne">
                                                            ...
                                                            <a class="dropdown-item" href="<?=base_url('alscoordinator/view_registration') . '/' . $coord['user_id']?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-dark">
                                                    ...
                                                    <div class="dropdown dropstart">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownprojectOne">
                                                            <h6 class="dropdown-header">Action</h6>
                                                            <a class="dropdown-item" href="<?=base_url('alscoordinator/view_barangay') . '/' . $coord['user_id']?>">
                                                                <i data-feather="eye" class="icon-xxs"></i>
                                                                View
                                                            </a>
                                                        </div>
