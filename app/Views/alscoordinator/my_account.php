    ...
    <div class="row gy-3">
        ...
        <div class="col-md-9">
            <div class="card p-3 rounded shadow-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php 
                            if(empty($als_account_info['image']) || !file_exists( FCPATH . 'uploads\\assets\\profiles\\' . str_replace('/', '\\' , $als_account_info['image']))){
                        ?>
                                ...
                                <form method="post" action="<?=base_url('alscoordinator/edit_picture')?>" enctype="multipart/form-data" id="editPicForm">
                        ...
                        ?>
                                <img style="width: 100px;height:100px;" class="border border-light border-5 rounded-circle" src="<?=base_url('public/uploads/assets/profiles') . '/' . str_replace('\\', '/' , $als_account_info['image'])?>" alt="">
        ...
        <div class="col-md-9">
            <div class="card p-3 rounded shadow-sm overflow-auto" id="contactDetailPane">
                <h5 id="contactHeader" class="fw-bold">Contact Details</h5>
                    ...
                    <?php if (!empty($als_account_contact) && is_array($als_account_contact)): ?>
                        <form id = "coordinatorContactForm" >
                            <input type="hidden" name="coordinator_id" value="<?=$als_account_contact['user_id']?>">
                            <div class="row gy-3">
                            <div class="col-md-3">
                                <label for="email" class="form-label">Email</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="email"  id="email" class="form-control" value="<?=$als_account_contact['email'];?>" readonly>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Facebook</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="facebook"  id="facebook" class="form-control" value="<?=$als_account_contact['facebook'];?>" readonly>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Contact</label>
                            </div>
                            <div class="col-md-9">
                                <input type="number" name="contact_no"  id="contact_no" class="form-control" value="<?=$als_account_contact['contact_no'];?>" readonly required>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Street</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="street"  id="street" class="form-control" value="<?=$als_account_contact['street'];?>" readonly>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Barangay</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="barangay"  id="barangay" class="form-control" value="<?=$als_account_contact['barangay'];?>" readonly>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">District</label>
                            </div>
                            <div class="col-md-9">
                                <input type="number" name="district"  id="district" class="form-control" value="<?=$als_account_contact['district'];?>" readonly min="1" required>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Zipcode</label>
                            </div>
                            <div class="col-md-9">
                                <input type="number" name="zip_code"  id="zip_code" class="form-control" value="<?=$als_account_contact['zip_code'];?>" readonly required>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">City</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="city"  id="city" class="form-control" value="<?=$als_account_contact['city'];?>" readonly>
                            </div>
        ...
        <div class="col-md-9">
            <div class="card p-3 rounded shadow-sm overflow-auto" id="infoDetailPane">
                ...
                <?php if (!empty($als_account_info) && is_array($als_account_info)): ?>
                    <form id = "coordinatorInfoForm" >
                        <input type="hidden" name="staff_id" value="<?=$als_account_info['user_id']?>">
                        <div class="row gy-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="row gy-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="firstname"  id="firstname" class="form-control" value="<?=$als_account_info['firstname']; ?>" readonly="true" placeholder="First name">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="middlename" class="form-text">Middle name</label>
                                        <input type="text" name="middlename"  id="middlename" class="form-control" value="<?=$als_account_info['middlename'];?>" readonly="true" placeholder="Middle name">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="middlename" class="form-text">Last name</label>
                                        <input type="text" name="lastname"  id="lastname" class="form-control" value="<?=$als_account_info['lastname'];?>" readonly="true" placeholder="Last name">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="middlename" class="form-text">Name Extension</label>
                                        <input type="text" name="suffix"  id="suffix" class="form-control" value="<?=$als_account_info['suffix'];?>" readonly="true">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input type="date" name="birth"  id="birth" class="form-control" value="<?=$als_account_info['birth'];?>" readonly="true">
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Age</label>
                            </div>
                            <div class="col-md-9">
                                <input type="number" name="age"  id="age" class="form-control" value="<?=$als_account_info['age'];?>" readonly="true" required >
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Gender</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="gender"  id="gender" class="form-control" value="<?=$als_account_info['gender'];?>" readonly="true">
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Civil Status</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="civil_status"  id="civil_status" class="form-control" value="<?=$als_account_info['civil_status'];?>" readonly="true">
                            </div>
                            <div class="col-md-3">
                                <label for="" class="form-label">Religion</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="religion"  id="religion" class="form-control" value="<?=$als_account_info['religion'];?>" readonly="true">
                            </div>
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
        ...
        <div class="col-md-9">
            <div class="card p-3 rounded shadow-sm"  id="accountDetailPane">
                ...
                <?php if (!empty($als_account) && is_array($als_account)): ?>
                    <form id = "coordinatorAccountForm">
                        <input type="hidden" name="coordinator_id" value="<?=$als_account['user_id']?>">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="username"  id="username" class="form-control" value="<?=$als_account['username'];?>" readonly="true">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="status"  id="status" class="form-control" value="<?=$als_account['status'] == 0 ? 'Offline' : 'Online';?>" readonly="true">
                            </div>
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
...
<script>
    ...
    if(coordinatorAccountForm){
        ...
        coordinatorAccountForm.addEventListener('submit', (e)=>{
            ...
            fetch('<?=base_url('alscoordinator/edit_password')?>', {
                method:'post',
                body:accountData
            })
    ...
    if(coordinatorContactForm){
        ...
        coordinatorContactForm.addEventListener('submit', (e)=>{
            ...
            fetch('<?=base_url('alscoordinator/edit_contact')?>', {
                method:'post',
                body:contactData
            })
            .then((response) => response.json())
    ...
    if(coordinatorInfoForm){
        ...
        coordinatorInfoForm.addEventListener('submit', (e)=>{
            ...
            fetch('<?=base_url('alscoordinator/edit_info')?>', {
                method:'post',
                body:infoData
            })
            .then((response) => response.json())
