        ...
        <div class="card">
            ...
            <div class="card-header bg-white py-4">
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap mb-0" id="teacher_table">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div class="icon-shape icon-sm">
                                                        ...
                                                        <?php else : ?>
                                                                <img src="<?=base_url('public/uploads/assets/profiles') . '/' . $teacher['image']?>" class="avatar avatar-sm rounded-circle">
                                                        <?php endif ?>
                                                    </div>
                                                </div>
                                                <div class="ms-3 lh-1">
                                                    <h5 class=" mb-1"><?= $teacher['user_id']?></h5>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-middle text-dark">
                                            ...
                                            <div class="dropdown dropstart">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownprojectOne">
                                                    ...
                                                    <a class="dropdown-item" href="<?=base_url('coordinator/view_teacher') . '/' . strtolower($teacher['user_id'])?>">
...
<script>
    const teacher_table = document.querySelector('#teacher_table');
