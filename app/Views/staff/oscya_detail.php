<div class="container pt-3">
    <div class="row g-3">
        ...
        <div class="col-md-12 text-end">
            <a class="btn btn-light btn-icon rounded-circle indicator indicator-primary text-muted" href="<?=base_url('staff/download_osy_mapping_form') .'/' . $oscya_info['oscya_id']?>" target="_blank" role="button"  data-bs-toggle="tooltip" data-placement="bottom" title="Download PDF Format">
                <span class="material-icons">file_download</span>
            </a>
            <a class="btn btn-light btn-icon rounded-circle indicator indicator-primary text-muted" href="<?=base_url('staff/generate_osy_mapping_form') .'/' . $oscya_info['oscya_id']?>" target="_blank" role="button"  data-bs-toggle="tooltip" data-placement="bottom" title="View PDF Format">
                <span class="material-icons">picture_as_pdf</span>
            </a>
            <a class="btn btn-light btn-icon rounded-circle indicator indicator-primary text-muted" href="#" role="button"  data-bs-toggle="tooltip" data-placement="bottom" title="Update all necessary data before printing the form">
                <i class="icon-sm" data-feather="help-circle"></i>
            </a>
                    ...
                    <?php if (!empty($oscya_info) && is_array($oscya_info)): ?>
                        <form id = "personalDetailsForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label for="extension" class="form-label">Full name</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" name="fullname" id="fullname" class="form-control" value="<?=$oscya_info['fullname']?>" readonly>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-9">
                                <select name="disability" id = "disability" class="form-select" readonly>
                                    ...
                                    <?php endif ?>
                                    <option selected>Select type of Disability</option>
                                    <option value="Intellectual Disability">Intellectual Disability</option>
                                    <option value="Learning Disability">Learning Disability</option>
                                    <option value="Autism">Autism</option>
                                    <option value="Blind">Blind</option>
...
<script>
    ...
    if (personalDetailsForm) {
        ...
        savePersonalDetails.addEventListener('click', (e) => {
            ...
            fetch("<?=base_url('staff/save_personal_detail')?>", {
                method: "post",
                body:formData
            }).then((response) => {
    ...
    if (contactDetailsForm) {
        ...
        saveContactDetails.addEventListener('click', (e)=>{
            ...
            fetch("<?=base_url('staff/save_contact_detail')?>", {
                method: "post",
                body:contactData
            }).then((response) => {
                return response.json();
    ...
    if (guardianDetailsForm) {
        ...
        saveGuardianDetails.addEventListener('click', (e)=> {
            ...
            fetch("<?=base_url('staff/save_guardian_detail')?>", {
                method:'post',
                body:guardianData
            })
    ...
    if(mappingDetailsForm){
        ...
        saveMappingDetails.addEventListener('click', (e) => {
            ...
            fetch("<?=base_url('staff/save_mapping_details')?>", {
                method: 'post',
                body:mappingData
            })
            .then((response) => response.json())
