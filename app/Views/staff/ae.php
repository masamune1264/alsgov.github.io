...
<body>
  ...
  <table class="oscya-data">
    <tr>
      <td><b><u><?=$oscya_info['fullname'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></b></td>
    </tr>
    <tr>
  ...
  <table class="oscya-data">
    ...
    <tr>
      <td style="text-align: center;width: 50%;">
        <b><u><?=$staff_info['lastname'] . ', ' . $staff_info['firstname'] . ' ' . $staff_info['middlename'] . ' ' . $staff_info['suffix']?></u></b>
      </td>
      <td style="text-align: center;width: 50%;">
        <b><u><?=$oscya_info['fullname']?></u></b>
      </td>
    </tr>
    <tr>
      <td style="text-align: center;width: 50%;"><small>Signature over printed name(Barangay Staff)</small></td>
      <td style="text-align: center;width: 50%;"><small>Signature over printed name(OSY)</small></td>
    </tr>
