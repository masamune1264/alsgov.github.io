        ...
        <div class="container d-flex flex-column">
            <div class="row align-items-center justify-content-center g-0 min-vh-100">
                <div class="col-12 col-md-8 col-lg-6 col-xxl-4 py-8 py-xl-0">
                    <div class="card smooth-shadow-md p-6">
                        <form action="<?=base_url('staff/forgot_password');?>" method="post">
                            <?=csrf_field();?>
                            <?php if (isset($error)) : ?>
                            ...
                            <?php endif; ?>
                            <h3 class="text-danger text-primary fw-bold">Forgot Password</h3>
                            ...
                            <div class="d-grid gap-2 mb-3">
                                <button class="btn btn-danger py-2 fw-bold" type="submit">Reset Password</button>
                            </div>
                            <div class="row justify-content-between">
                                <div class="col-md-6">
                                    <a href="<?=base_url('staff/login')?>" class="text-danger"> Sign In</a>
                                </div>
                                <div class="col-md-6 text-end">
                                    <a href="<?=base_url('registration/brgy_staff')?>" class="text-dark">Create Account</a>
                                </div>
                            </div>
                        </form>
                    </div>
